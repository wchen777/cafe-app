...
export default function Landing({navigation}) { 
    return (
        <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#FFFDFC'}}>
        <View style={{ flexDirection: 'column'}}>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center'}}>
                <Image style={{width: 120, height: 100}} source={require('./logo.jpg')}/>
            </View>
            <Text style={{textAlign: 'center', fontSize: 35, fontWeight: 'bold', marginTop: 30}}>Sign In</Text>
